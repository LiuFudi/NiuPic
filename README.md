...
```bash
# 1. 安装牛图 NiuPic（应用中心 → 手动安装 → niupic_2.1.0_x86.fpk）
...
- 🎨 **主题色自定义** —— 12 种预设色 + 色轮（色相/饱和度/明度），换主题色全站立即生效并记住
- 🔍 **智能搜索** —— 多关键词组合、按格式 / 大小 / 方向 / 评分筛选
- ↕️ **灵活排序** —— 任意层级可用，15 个排序字段（时间 / 文件名 / 大小 / 分辨率 / 宽高比 /
  格式 / 类型 / 评分 / 收藏 / 所在文件夹 / 随机），文件名走自然排序，偏好跨刷新记住
